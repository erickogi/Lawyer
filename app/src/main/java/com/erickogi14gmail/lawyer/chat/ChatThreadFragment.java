...
public class ChatThreadFragment extends Fragment {
    ...
    void setView(){
        getActivity().setTitle("Accidents Lawyer-Ahmed Om");
        recyclerView=(RecyclerView)view.findViewById(R.id.recyclerChat);
        chatsAdapter=new ChatsAdapter(getActivity(),populateList());
    ...
    private ArrayList<ChatPojo> populateList() {
        ChatPojo chatPojo1=new ChatPojo(1,0,"hello there");

        ChatPojo chatPojo2=new ChatPojo(1,0,"hello there");
        ChatPojo chatPojo3=new ChatPojo(1,1,"hello to how may i help you");
        ChatPojo chatPojo4=new ChatPojo(1,0,"I need attorney advice");
        ChatPojo chatPojo5=new ChatPojo(1,1,"On what Specifically .I hope you have read our terms and conditions and service pricing");
        ChatPojo chatPojo6=new ChatPojo(1,0,"Yes sure i have");
        ChatPojo chatPojo7=new ChatPojo(1,0,"My car was involved in an accident and am supposed to appear before a court on Monday");
        ChatPojo chatPojo8=new ChatPojo(1,0,"I need couching");
        ChatPojo chatPojo9=new ChatPojo(1,1,"For couching you should book a face to face appointment");
        ChatPojo chatPojo10=new ChatPojo(1,0,"Okay thank you i will do that");
